        ...
        <div className="grid gap-14 lg:grid-cols-[1fr_1.1fr]">
          ...
          <Reveal delay={0.08}>
            <div className="space-y-5 text-base leading-8 text-muted md:text-lg">
              <p>
                My background is in{" "}
                <span className="font-medium text-fg">Computer Science</span>, so
                I see software as one part of a larger system: data travelling
              ...
              <p>
                ...
                networks and databases actually work is what lets me reason about{" "}
                <span className="font-medium text-fg">why</span> something is
                slow, insecure or fragile — and fix the cause instead of the
                symptom.
              </p>
            </div>
          </Reveal>
